...
const BUILDS: Build[] = [
  ...
  {
    id: 'build-004',
    slug: 'chris-c8-corvette-intake-exhaust',
    title: 'Chris\'s C8 Corvette — Intake & Exhaust',
    vehicle: { year: 2020, make: 'Chevrolet', model: 'Corvette C8' },
    category: 'daily-driver',
    modsPerformed: [
      'High-flow cold air intake system',
      'Stainless headers (equal-length)',
      'Performance cat-back exhaust with valve control',
      'Custom tune with exhaust valve mapping',
    ],
    hpBefore: 490,
    hpAfter: 550,
    torqueBefore: 465,
    ...
    writeup:
      'Chris wanted more sound and some extra power without voiding his factory warranty on the internals. The intake and exhaust combo unlocked 60 extra WHP and transformed the exhaust note. The valve-controlled exhaust keeps it quiet at cruise and screams at WOT. It is the best of both worlds for a daily-driven C8.',
    costRange: '$4,000 – $5,500',
    status: 'published',
  },
  {
    id: 'build-005',
    slug: 'devon-f150-ecoboost-turbo',
    title: 'Devon\'s F-150 EcoBoost — Turbo Upgrade',
    vehicle: { year: 2017, make: 'Ford', model: 'F-150 EcoBoost' },
    category: 'street',
    modsPerformed: [
      'Upgraded turbochargers (drop-in)',
      'Downpipes (catted)',
    ...
    writeup:
      'Devon wanted his F-150 to be the fastest truck at the meets. We upgraded the factory turbos with larger drop-in units, added a front-mount intercooler, and tuned on E85. The result is 480 WHP and 550 lb-ft — enough to gap most muscle cars while still towing on the weekends. The torque curve on this thing is absolutely flat from 3,000 RPM.',
