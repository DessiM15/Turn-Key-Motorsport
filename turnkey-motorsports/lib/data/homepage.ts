...
export const HOMEPAGE_CATEGORIES: HomepageCategory[] = [
  {
    id: 'engine-parts',
    name: 'Engine Parts',
    description: 'Cams, heads, pistons, and bottom-end components',
  ...
  },
  {
    id: 'intake-exhaust',
    name: 'Intake & Exhaust',
    description: 'Cold air intakes, headers, and full exhaust systems',
  ...
  },
  {
    id: 'fuel-system',
    name: 'Fuel Systems',
    description: 'Injectors, pumps, regulators, and E85 conversion kits',
...
export const HOMEPAGE_TESTIMONIALS: HomepageTestimonial[] = [
  ...
  },
  {
    ...
    rating: 5,
    text: 'The intake and exhaust combo they recommended completely transformed the car. 60 extra wheel HP and the sound is addicting. These guys know their stuff.',
  },
  {
    id: 'test-6',
    ...
    vehicleYear: 2017,
    vehicleMake: 'Ford',
    vehicleModel: 'F-150 EcoBoost',
    rating: 5,
    text: 'Brought my truck in for a turbo upgrade and tune. They got it making 480 to the wheels — on a truck! The dyno numbers don\'t lie. Highly recommend.',
  },
];
